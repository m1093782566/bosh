  ...
  context 'installed by base_apt' do
    {
      ...
      'curl'                 => '7.22.0-3ubuntu4.5',
      'wget'                 => '1.13.4-2ubuntu1',
      'libcurl3'             => '7.22.0-3ubuntu4.5',
      'libcurl4-openssl-dev' => '7.22.0-3ubuntu4.5', # installed because of 'libcurl3-dev'
...
#      'rsyslog-relp'         => '5.8.6-1ubuntu8.5',
  ...
  context 'installed by system_kernel' do
    {
      'linux-image-virtual'       => '3.2.0.57.68',
      'linux-image-extra-virtual' => '3.2.0.57.68',
    }.each do |pkg, version|
      describe package(pkg) do
        it { should be_installed.with_version(version) }
      end
  ...
  context 'installed by image_install_grub' do
    describe file('/boot/grub/grub.conf') do
      ...
      it { should contain 'title Ubuntu 12.04.3 LTS (3.2.0-57-virtual)' }
      it { should contain '  root (hd0,0)' }
      it { should contain '  kernel /boot/vmlinuz-3.2.0-57-virtual ro root=UUID=' }
      it { should contain ' selinux=0' }
      it { should contain '  initrd /boot/initrd.img-3.2.0-57-virtual' }
    end
